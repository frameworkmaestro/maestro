...
class MForm extends MControl
{
    ...
    public function addControl($control)
    {
        ...
        if (($className == 'fields') || ($className == 'buttons') || ($className == 'help') || ($className == 'tools')) {
    ...
    public function generate()
    {
        ...
        $panel->property->toolbar = $this->property->toolbar;
        $panel->property->class = $this->property->class;
        $panel->options->border = isset($this->style->border) ? $this->style->border : true;
        ...
        $this->page->onSubmit("true", $this->property->id);
