...
class LabelMap extends \MBusinessModel {
    ...
    public static function ORMMap() {
        ...
        return array(
            ...
            'associations' => array(
                'entity' => array('toClass' => 'fnbr20\models\Entity', 'cardinality' => 'oneToOne' , 'keys' => 'idLabelType:idEntity'), 
                'layer' => array('toClass' => 'fnbr20\models\Layer', 'cardinality' => 'oneToOne' , 'keys' => 'idLayer:idLayer'), 
                'instantiationType' => array('toClass' => 'fnbr20\models\TypeInstance', 'cardinality' => 'oneToOne' , 'keys' => 'idInstantiationType:idTypeInstance'), 
            )
        );
    }
