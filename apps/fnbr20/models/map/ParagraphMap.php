...
class ParagraphMap extends \MBusinessModel {
    ...
    public static function ORMMap() {
        ...
        return array(
            ...
            'associations' => array(
                'document' => array('toClass' => 'fnbr20\models\Document', 'cardinality' => 'oneToOne' , 'keys' => 'idDocument:idDocument'), 
                'sentences' => array('toClass' => 'fnbr20\models\Sentence', 'cardinality' => 'oneToMany' , 'keys' => 'idParagraph:idParagraph'), 
            )
        );
    }
