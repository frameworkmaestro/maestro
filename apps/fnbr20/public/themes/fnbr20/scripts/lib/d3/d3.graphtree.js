	...
	init: function(o)
	{
        ...
        loadNodesStruct: function(struct) {
            ...
            $.each(struct.links, function (i, link){
                ...
                that.addLinkById(l); 
                parent = that.findNode(link.source);
                child = that.findNode(link.target);
        ...
        loadNodesSpread: function(struct) {
            var that = this;
            $.each(struct.nodes, function (i, node){
                if (node.typeSystem != '') {
                    node.run = [];
        ...
        loadNodesAnalysis: function(struct) {
            this.clear();
            var that = this;
            $.each(struct.nodes, function (i, node){
                if (node.typeSystem != '') {
        ...
        spreadMatch: function(sourceWord, runNumber) {
            var source = this.findNodeByType(sourceWord);
            source.run.push(runNumber);
            return this.spreadMatch(source, 1, runNumber);
        },
        ...
        /*
        loadNode: function(source, a, runNumber) {
                if (source.visited) {
                    return;
                }
                if (!this.findNode(source.id)) {
                    this.addNode(source);
                }    
                source.visited = true;
                $.each(this.struct.links, function (i, link){
                    if (link.source == source.id) {
                        l = {
                            source: this.struct.nodes[link.source],
                            target: this.struct.nodes[link.target],
                            type: (link.label == "" ? 'rel_common' : link.label)
                        };
                        this.addLink(l);
                        this.loadNode(l.target, 1, runNumber);
                    }    
                });
        },    
        */
