    ...
    public function addConstraintsCE($data)
    {
        try {
            ...
            if ($data->idConstruction != '') {
                ...
                $ce = new \fnbr20\models\ConstructionElement($data->idConstructionElement);
                $cxn = new \fnbr20\models\Construction($data->idConstruction);
            ...
            if ($data->idFrameFamily != '') {
                $constraint = Base::createEntity('CN', 'con');
                $ce = new \fnbr20\models\ConstructionElement($data->idConstructionElement);
                $frame = new \fnbr20\models\Frame($data->idFrameFamily);
            ...
            if ($data->idConstructionBefore != '') {
                $constraint = Base::createEntity('CN', 'con');
                $ce = new \fnbr20\models\ConstructionElement($data->idConstructionElement);
                $ceBefore = new \fnbr20\models\ConstructionElement($data->idConstructionBefore);
    ...
    public function addConstraintsCN($data)
    {
        ...
        try {
            ...
            if ($data->idConstructionElement != '') {
                $constraint = Base::createEntity('CN', 'con');
                $cn = new \fnbr20\models\Constraint($data->idConstraint);
                $ce = new \fnbr20\models\ConstructionElement($data->idConstructionElement);
