...
class AcessoMap extends \MBusinessModel {
    ...
    public static function ORMMap() {
        ...
        return array(
            ...
            'associations' => array(
                'transacao' => array('toClass' => '\exemplos\models\transacao', 'cardinality' => 'oneToOne' , 'keys' => 'idTransacao:idTransacao'), 
                'grupo' => array('toClass' => '\exemplos\models\grupo', 'cardinality' => 'oneToOne' , 'keys' => 'idGrupo:idGrupo'), 
            )
        );
    }
